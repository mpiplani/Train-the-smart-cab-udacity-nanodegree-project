...
class LearningAgent(Agent):
	...
	self.a = 0.01
	self.epsilon = math.e**(-self.a * self.train_number)
	if testing:
		self.epsilon=0
		self.alpha=0
	...
	if not self.learning:
		...
		if random.random() > self.epsilon:
			...
			actions = [act for act, val in self.Q[state].items() if val == max_qvalue]
			#for actions in self.valid_actions:
			#	if self.Q[state][actions]==max_qvalue:
			#		max_values.append(actions)
